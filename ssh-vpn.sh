...
organization="NiLphreakz-Project"
organizationalunit="NiLphreakz-Project"
commonname="NiLphreakz-Project"
email="NiLphreakz-project@gmail.com"
...
wget https://github.com/NiLphreakz/vnstat/releases/download/vnstat/vnstat-2.6.tar.gz
